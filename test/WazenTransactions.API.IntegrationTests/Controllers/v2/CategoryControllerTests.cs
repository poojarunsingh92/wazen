...
using WazenTransactions.API.IntegrationTests.Base;
//using WazenTransactions.Application.Features.Categories.Commands.CreateCateogry;
//using WazenTransactions.Application.Features.Categories.Queries.GetCategoriesList;
//using WazenTransactions.Application.Features.Categories.Queries.GetCategoriesListWithEvents;
using WazenTransactions.Application.Models.Authentication;
using WazenTransactions.Application.Responses;
using Xunit;

namespace WazenTransactions.API.IntegrationTests.Controllers.v2
{
    [Collection("Database")]
