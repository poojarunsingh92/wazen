...
{
    public class CustomerAdminCustomerConsumerService : BackgroundService
    {
        public AzureServiceBusConnectionString _azureService { get; }
        string connectionString = String.Empty;
        static ISubscriptionClient subscriptionClient;
        static string topicName = "AdminCustomer";
        static string subscriptionName = "SubCustomerAdminCustomer";
        private readonly IServiceProvider _serviceProvider;

        public CustomerAdminCustomerConsumerService(IOptions<AzureServiceBusConnectionString> azureService, IServiceProvider serviceProvider)
        {
