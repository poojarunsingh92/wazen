...
{
    public class ACIGTPLQuoteCommandHandler : IRequestHandler<ACIGTPLQuoteCommand, Response<ACIGTPLQuoteResponse>>
    {
        private readonly IMediator _mediator;
        private readonly ILogger _logger;
        private readonly Random _random = new Random();

        public ACIGTPLQuoteCommandHandler(IMediator mediator, ILogger<ACIGTPLQuoteCommandHandler> logger)
        {
            _mediator = mediator;
            _logger = logger;
        }

        public async Task<Response<ACIGTPLQuoteResponse>> Handle(ACIGTPLQuoteCommand request, CancellationToken cancellationToken)
        {
            //request.UserId = "";
            ...
            ACIGTPLQuoteCommand quoteRequest = new ACIGTPLQuoteCommand();
            ...
            string body = JsonSerializer.Serialize<ACIGTPLQuoteCommand>(quoteRequest,opt);
            ...
            {
                var responseACIGQuotes = new Response<ACIGTPLQuoteResponse>();
                return responseACIGQuotes;
            }
            var actualResponseACIG = JsonSerializer.Deserialize<ACIGTPLQuoteResponse>(newResponseACIG);
            var responseACIGQuote = new Response<ACIGTPLQuoteResponse>(actualResponseACIG);
