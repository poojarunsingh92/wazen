...
{
    class GetQuoteResponseByCustomerIDVehicleIDQueryHandler : IRequestHandler<GetQuoteResponseByCustomerIDVehicleIDQuery, Response<QuoteResponse>>
    {
        ...
        private readonly ITempVehicleViolationRepository _tempVehicleViolationRespository;
        private readonly IVehicleViolationRepository _vehicleViolationRespository;
        private readonly IQuoteResponseRepository _quoteResponseRepository;

        //Repositories objects of ICs LookUp Tables
        private readonly IAdditionalCoverRepository _additionalCoverRepository;
        private readonly IBankCodeRepository _bankCodeRepository;
        private readonly ICardIdTypeRepository _cardIdTypeRepository;
        private readonly ICitiesRepository _citiesRepository;
        private readonly ICountriesRepository _countriesRepository;
        private readonly IDeductableRepository _deductableRepository;
        private readonly IDiscountRepository _discountRepository;
        private readonly IDriverTypeRepository _driverTypeRepository;
        private readonly IDrivingPercentageRepository _drivingPercentageRepository;
        private readonly IEducationRepository _educationRepository;
        private readonly IGenderRepository _genderRepository;
        private readonly IHealthConditionRepository _healthConditionRepository;
        private readonly IImageTitleRepository _imageTitleRepository;
        ...
        private readonly INCDFreeYearRepository _nCDFreeYearRepository;
        private readonly IOccupationRepository _occupationRepository;
        private readonly IParkingLocationRepository _parkingLocationRepository;
        private readonly IPaymentMethodRepository _paymentMethodRepository;
        private readonly IPlateLetterRepository _plateLetterRepository;
        private readonly IPremiumBreakdownRepository _premiumBreakdownRepository;
        ...
        private readonly IVehicleAxlesWeightRepository _vehicleAxlesWeightRepository;
        private readonly IVehicleColorRepository _vehicleColorRepository;
        private readonly IVehicleEngineSizeRepository _vehicleEngineSizeRepository;
        private readonly IVehicleIdTypeRepository _vehicleIdTypeRepository;
        private readonly IVehiclePlateTypeRepository _vehiclePlateTypeRepository;
        private readonly IVehicleSpecificationRepository _vehicleSpecificationRepository;
        private readonly IVehicleUsesRepository _vehicleUsesRepository;
        private readonly IViolationRepository _violationRepository;

        public GetQuoteResponseByCustomerIDVehicleIDQueryHandler(IMapper mapper, IMediator mediator, IQuoteResponseRepository quoteResponseRepository, ILogger<GetQuoteResponseByCustomerIDVehicleIDQueryHandler> logger, ITempVehicleViolationRepository tempVehicleViolationRespository, IVehicleViolationRepository vehicleViolationRespository,
            IAdditionalCoverRepository additionalCoverRepository,
            IBankCodeRepository bankCodeRepository,
            ICitiesRepository citiesRepository,
            ICardIdTypeRepository cardIdTypeRepository,
            ICountriesRepository countriesRepository,
            IDeductableRepository deductableRepository,
            IDiscountRepository discountRepository,
            IDriverTypeRepository driverTypeRepository,
            IDrivingPercentageRepository drivingPercentageRepository,
            IEducationRepository educationRepository,
            IGenderRepository genderRepository,
            IHealthConditionRepository healthConditionRepository,
            IImageTitleRepository imageTitleRepository,
            ...
            INCDFreeYearRepository nCDFreeYearRepository,
            IOccupationRepository occupationRepository,
            IParkingLocationRepository parkingLocationRepository,
            IPaymentMethodRepository paymentMethodRepository,
            IPlateLetterRepository plateLetterRepository,
            IPremiumBreakdownRepository premiumBreakdownRepository,
            ...
            IVehicleAxlesWeightRepository vehicleAxlesWeightRepository,
            IVehicleColorRepository vehicleColorRepository,
            IVehicleEngineSizeRepository vehicleEngineSizeRepository,
            IVehicleIdTypeRepository vehicleIdTypeRepository,
            IVehiclePlateTypeRepository vehiclePlateTypeRepository,
            IVehicleSpecificationRepository vehicleSpecificationRepository,
            IVehicleUsesRepository vehicleUsesRepository,
        ...
        public async Task<Response<QuoteResponse>> Handle(GetQuoteResponseByCustomerIDVehicleIDQuery request, CancellationToken cancellationToken)
        {
            ...
            List<ICAdditionalCoverr> additionalCoverList = await _additionalCoverRepository.GetAdditionalCover();            
            List<ICBankCode> bankCodeList = await _bankCodeRepository.GetBankCode();
            List<ICCardIdType> cardIdTypeList =  await _cardIdTypeRepository.GetCardIdType();
            List<ICCities> citiesList = await _citiesRepository.GetCities();
            List<ICCountries> countriesList = await _countriesRepository.GetCountries();
            List<ICDeductable> deductableList = await _deductableRepository.GetDeductable();
            List<ICDiscount> discountList =  await _discountRepository.GetDiscount();
            List<ICDriverType> driverTypeList = await _driverTypeRepository.GetDriverType();
            List<ICDrivingPercentage> drivingPercentageList = await _drivingPercentageRepository.GetDrivingPercentage();
            List<ICEducation> educationList = await _educationRepository.GetEducation();
            List<ICGender> genderList = await _genderRepository.GetGender();
            List<ICHealthCondition> healthConditionList = await _healthConditionRepository.GetHealthCondition();
            List<ICImageTitle> imageTitleList = await _imageTitleRepository.GetImageTitle();
            List<ICLicenseType> licenseTypeList = await _licenseTypeRepository.GetLicenseType();
            List<ICMaritalStatus> maritalStatusList = await _maritalStatusRepository.GetMaritalStatus();
            List<ICMileages> mileageList = await _mileageRepository.GetMileage();
            List<ICNationality> nationalitiesList = await _nationalityRepository.GetNationality();
            List<ICNCDFreeYear> nCDFreeYearList = await _nCDFreeYearRepository.GetNCDFreeYear();
            List<ICOccupation> occupationList = await _occupationRepository.GetOccupation();
            List<ICParkingLocation> parkingLocationList = await _parkingLocationRepository.GetParkingLocation();
            List<ICPaymentMethod> paymentMethodList = await _paymentMethodRepository.GetPaymentMethod();
            List<ICPlateLetter> plateLetterList = await _plateLetterRepository.GetPlateLetter();
            List<ICPremiumBreakdownn> premiumBreakList = await _premiumBreakdownRepository.GetPremiumBreakdown();
            List<ICPriceType> priceTypeList = await _priceTypeRepository.GetPriceType();
            List<ICProductType> productTypeList = await _productTypeRepository.GetProductType();
            List<ICRelationship> relationshipList = await _relationshipRepository.GetRelationship();
            List<ICRepairType> repairTypeList = await _repairTypeRepository.GetRepairType();
            List<ICTransmissionType> transmissionTypeList = await _transmissionTypeRepository.GetTransmissionType();
            List<ICVehicleAxlesWeight> vehicleAxlesWeightList = await _vehicleAxlesWeightRepository.GetVehicleAxlesWeight();
            List<ICVehicleColor> vehicleColorList = await _vehicleColorRepository.GetVehicleColor();
            List<ICVehicleEngineSize> vehicleEngineSizeList = await _vehicleEngineSizeRepository.GetVehicleEngineSize();
            List<ICVehicleIdType> vehicleIdTypeList = await _vehicleIdTypeRepository.GetVehicleIdType();
            List<ICVehiclePlateType> vehiclePlateTypeList = await _vehiclePlateTypeRepository.GetVehiclePlateType();
            List<ICVehicleSpecificationn> vehicleSpecificationList = await _vehicleSpecificationRepository.GetVehicleSpecification();
            List<ICVehicleUses> vehicleUsesList = await _vehicleUsesRepository.GetVehicleUses();
            List<ICViolation> violationList = await _violationRepository.GetViolation();
            
            _logger.LogInformation("InsuranceCompanies LookUp Table Values Fetch Completed");



            QuoteResponse listQuotes = new QuoteResponse();
            ...
            if (request.QuoteType == "TPL")
            {
                ...
                NCDEligibilityResponse nCDEligibilityResponse = new NCDEligibilityResponse();
                if (newResponse != "")
                    nCDEligibilityResponse = JsonSerializer.Deserialize<NCDEligibilityResponse>(newResponse);
            ...
            ListQuotes:
            return new Response<QuoteResponse>(listQuotes);
        }
    }
}