...
{
    public class VehicleUpgradePolicyListByCustomerIDVm
    {
    ...
    public class VehicleInformations
    {
        ...
        public CustomerPoliciess CustomerPolicies { get; set; } // With ICollection
        //public CustomerPolicies1 CustomerPolicies { get; set; }  // without ICollection
    }
    public class CustomerPoliciess
    {
        public Guid Id { get; set; }
        ...
        public List<AdditionalCoverageInformations> CustomerPolicyAdditionalCoverage { get; set; }
    }
    public class AdditionalCoverageInformations
    {
        public Guid Id { get; set; }
