...
using System;
using System.Text;
using WazenCustomer.Application.Contracts.Identity;
using WazenCustomer.Application.Models.Authentication;
using WazenCustomer.Identity.Models;
using WazenCustomer.Identity.Services;

namespace WazenCustomer.Identity
{
